...
const faqItems = [
  {
    ...
    answer: "Si. Enviamos a toda la Republica Mexicana. El tiempo estimado es de 2 a 6 dias habiles segun el destino y operador logístico.",
  },
  {
    id: "autenticidad",
    question: "¿Como garantizan la autenticidad de los productos?",
    answer: "Todos los suplementos de Gain Lab pasan por validacion de proveedor, control de lote y verificacion de calidad antes de publicarse.",
  },
  {
    id: "metodos-pago",
    question: "¿Que metodos de pago estan disponibles?",
    answer: "Actualmente operamos con confirmacion interna de compra. La integracion de pagos online (tarjeta y wallets) sera habilitada en la siguiente fase.",
  },
  {
    id: "seguimiento",
    question: "¿Puedo rastrear mi pedido?",
    answer: "Si. Una vez confirmado, recibirás actualizaciones de estado y detalles de envio para seguimiento nacional.",
  },
]
